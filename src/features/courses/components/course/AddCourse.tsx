...
import { addInstructor } from "src/features/instructors/reducers/instructor.reducer";
...
const AddCourse: FC = (): ReactElement => {
  ...
  const onCreateCourse = async (): Promise<void> => {
    try {
            ...
            <div className="mb-12 grid md:grid-cols-5">
              ...
              <div className="relative col-span-4 md:w-11/12 lg:w-8/12">
                <Dropdown
                  ...
                  onClick={(item: string) => {
                    setCourseInfo({ ...courseInfo, expectedDuration: item });
                  }}
                />
              </div>
            </div>
