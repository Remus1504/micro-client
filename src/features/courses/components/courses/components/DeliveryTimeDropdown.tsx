...
import { saveToLocalStorage } from "src/shared/utils/utils";
...
const DurationTimeDropdown: FC = (): ReactElement => {
    ...
    <div className="flex flex-col">
      <div className="relative">
        <Button
          ...
          label={
            <>
              <span className="truncate">Duration time</span>
              {!toggleDropdown ? (
...
export default DurationTimeDropdown;
