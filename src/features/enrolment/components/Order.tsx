...
import { IOrderDocument } from "../interfaces/enrolment.interface";
...
const Order: FC = (): ReactElement => {
  ...
  const { data, isSuccess } = useGetEnrolmentByEnrolmentIdQuery(`${orderId}`);
    ...
    <div className="container mx-auto">
      <div className="flex flex-wrap">
        <div className="order-last w-full p-4 lg:order-first lg:w-2/3">
          ...
          {order && order.studentUsername === authUser.username && (
              ...
              <div className="flex w-full flex-col flex-wrap p-4 md:w-2/3">
                ...
                {order?.delivered ? (
                  <p className="mt-1 w-5/6 flex-wrap text-sm">
                    ...
                    need. Let {order.instructorUsername} know your thoughts.
                  </p>
                ) : (
                  <>
                    <p className="mt-1 w-5/6 flex-wrap text-sm">
                      We notified {order.instructorUsername} about your order.
                    </p>
                    <p className="mt-1 w-5/6 flex-wrap text-sm">
