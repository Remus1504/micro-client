...
import { sliderImages, sliderImagesText } from "src/shared/utils/static";
import { ISliderState } from "../interfaces/homepage.interface";
          ...
          {sliderImages.map((_, index: number) => (
            <div
              ...
              className={`h-2 w-2 rounded-full ${
                slideIndex === index ? "bg-sky-500" : "bg-gray-300"
              }`}
            ></div>
          ))}
        </div>
