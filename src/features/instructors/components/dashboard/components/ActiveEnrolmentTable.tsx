...
const ActiveEnrolmentsTable: FC<IActiveOrderProps> = ({
  activeEnrolments,
}): ReactElement => {
        ...
        {activeEnrolments.length > 0 ? (
          <>
            ...
            <tbody className="flex-1 sm:flex-none">
              {activeEnrolments.map((order: IEnrolmentDocument) => (
                <tr
                  key={uuidv4()}
                ...
                >
                  ...
                  <td className="px-3 py-1 text-left lg:p-3 lg:text-center">
                    <Link
                      to={`/orders/${order.courseId}/activities`}
...
export default ActiveEnrolmentsTable;
