...
import { countriesList, degreeList, yearsList } from "src/shared/utils/utils";
...
const EducationFields: FC<IEducationEditProps> = ({
  ...
  const onHandleUpdate = (): void => {
    if (type === "add") {
      ...
      if (setInstructorProfile && setShowEducationAddForm) {
      ...
      if (setInstructorProfile && setShowEducationEditForm) {
        setInstructorProfile({ ...instructorProfile, education: filtered });
