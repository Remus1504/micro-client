...
const CertificateEditFields: FC<ICertificateEditProps> = ({
  ...
  const onHandleUpdate = (): void => {
    ...
    if (type === "add") {
      ...
      if (setInstructorProfile && setShowCertificateAddForm) {
      ...
      if (setInstructorProfile && setShowCertificateEditForm) {
        setInstructorProfile({ ...instructorProfile, certificates: filtered });
