...
import { IExperience } from "src/features/instructors/interfaces/instructor.interface";
...
const Experience: FC = (): ReactElement => {
  ...
  const { showEditIcons, instructorProfile } = useContext(instructorContext);
  ...
  return (
    <div className="border-grey mt-6 border bg-white">
      ...
      <ul className="mb-0 list-none pt-1.5">
        ...
        {!showExperienceAddForm && (
          <>
            {instructorProfile?.experience.map((experience: IExperience) => (
