...
import { yearsList } from "src/shared/utils/utils";
...
const ExperienceFields: FC<IExperienceEditProps> = ({
  ...
  const onHandleUpdate = () => {
    if (type === "add") {
      ...
      if (setInstructorProfile && setShowExperienceAddForm) {
      ...
      if (setInstructorProfile && setShowExperienceEditForm) {
        setInstructorProfile({ ...instructorProfile, experience: filtered });
        ...
        <div className="mb-6 px-3 md:mb-16">
          ...
          <div className="grid h-1/5 grid-cols-2 gap-x-2 gap-y-3">
            ...
            <div
              ...
              style={{
                cursor: `${
                  experienceItem.currentlyWorkingHere ? "none" : "pointer"
                }`,
                pointerEvents: `${
                  experienceItem.currentlyWorkingHere ? "none" : "auto"
                }`,
              }}
            >
              <Dropdown
