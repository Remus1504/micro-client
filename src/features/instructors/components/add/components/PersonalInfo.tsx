...
import { IPersonalInfoProps } from "src/features/instructors/interfaces/instructor.interface";
        ...
        <div className="w-full col-span-4">
          <TextInput
            ...
            onKeyDown={(event: KeyboardEvent) => {
              const currentTextLength = (event.target as HTMLInputElement).value
                .length;
              if (
                currentTextLength === maxOneLinerCharacters &&
                event.key !== "Backspace"
              ) {
