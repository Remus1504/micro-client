...
import { ISkillProps } from "src/features/instructors/interfaces/instructor.interface";
import Button from "src/shared/Button/Button";
import TextInput from "src/shared/Entries/Input";

const InstructorSkillField: FC<ISkillProps> = ({
  skillsFields,
  setSkillsFields,
}): ReactElement => {
...
export default InstructorSkillField;
