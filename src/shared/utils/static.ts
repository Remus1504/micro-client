...
import { ICreateCourse } from 'src/features/courses/interfaces/course.interface';
import { ICategory } from 'src/features/Home/interfaces/homepage.interface';
import { IRatingTypes } from 'src/features/enrolment/interfaces/review.interface';
...
export const emptyStudentData: StudentDocument = {
  _id: '',
  username: '',
  email: '',
  profilePicture: '',
...
export const emptyInstructorData: InstructorDocument = {
  _id: '',
  profilePublicId: '',
  fullName: '',
  profilePicture: '',
...
export const emptyCourseData: ICreateCourse = {
  _id: '',
  id: '',
  instructorId: '',
  title: '',
